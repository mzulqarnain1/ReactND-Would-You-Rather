...
In this app, users is able to answer questions, see which questions they haven’t answered, see how other people have voted, post questions, and see the ranking of users on the leaderboard.
...
![Screenshot](docs/question.png)

* **_Poll Results_**

![Screenshot](docs/poll-results.png)

* **_Create Question_**

![Screenshot](docs/new-question.png)

* **_Leaderboard_**

![Screenshot](docs/board.png)
